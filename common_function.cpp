...
{
	g_img_menu = LoadImage("helicopter.png");
	if(g_img_menu == NULL)
	{
		return 1;
	}
...
// apply surface for explosion
void SDLCommonFunc:: AppluSurfaceClip(SDL_Surface* src, SDL_Surface* des, SDL_Rect* clip, int x, int y)
{
	SDL_Rect offset;
	offset.x = x;
	offset.y = y;
